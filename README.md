...
Not sure where to start? These are the entries worth reaching for first, by goal.

| If you want to...                                                                                                            | Reach for                                     | Jump to                                                                                                       |
| ---------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| Evaluate an LLM's biographical reasoning, or check whether a generated biography is factually accurate                       | **ADAM** / **FActScore biography benchmark**  | [LLM biographical-reasoning and factuality benchmarks](#llm-biographical-reasoning-and-factuality-benchmarks) |
| Build a person-centric temporal knowledge graph from scratch, or train/evaluate structured-data-to-text biography generation | **EventKG** / **WikiBio**                     | [General-purpose biography and person-event corpora](#general-purpose-biography-and-person-event-corpora)     |
| Extract structured events from one already-selected document (a paper, case report, dictionary entry)                        | **PubMed Case Report LLM framework**          | [LLM-based single-document extraction](#llm-based-single-document-extraction)                                 |
| Summarize a long-running _news_ story into a dated timeline                                                                  | **CHRONOS**                                   | [LLM-based multi-document timeline generation](#llm-based-multi-document-timeline-generation)                 |
| Get exact, provably correct event ordering from annotated text                                                               | **TLEX**                                      | [Classic NLP and statistical pipelines](#classic-nlp-and-statistical-pipelines)                               |
| Visualize a large biographical timeline interactively                                                                        | **TimeScape** (via the painter-cohorts paper) | [Visualization](#visualization)                                                                               |
...
### General-purpose biography and person-event corpora
...
### Curated national biography knowledge graphs
...
### Biographical event and relation extraction training data
...
### Multi-document news timeline-summarization benchmarks
...
### Closest single-document analog outside biography
...
### LLM biographical-reasoning and factuality benchmarks
...
### Classic NLP and statistical pipelines
...
### LLM-based multi-document timeline generation
...
### LLM-based single-document extraction
